...
class State(rx.State):
    ...
    def select_and_process_industry(self, field_name: str):
        """Sets the current field and processes it immediately when a card is clicked"""
        self.current_field = field_name
        return State.process_field
...
def info_card(title: str, desc: str, target_field: str) -> rx.Component:
    return rx.box(
        rx.text(
            title,
            font_weight="bold",
        ...
        on_click=State.select_and_process_industry(target_field),
        ...
        rx.vstack(
            ...
            rx.cond(
                ...
                rx.vstack(
                    ...
                    rx.text(
                        "Are you currently working in this industry? Your perspective is vital. Please share whether these findings align with your real-world experience.",
                        font_size="0.95rem",
                        color="#d4d4d4",
                    ),
            ...
            rx.vstack(
                ...
                rx.link(
                    ...
                    href="https://www.linkedin.com",  # Paste your actual profile link here if desired
                    is_external=True,
                ),
